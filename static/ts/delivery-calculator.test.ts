...
describe('DeliveryCalculator', () => {
    test('calculateDeliveryValueSimple dla PLN', () => {
        ...
        // Obliczenie
        const result = DeliveryCalculator.calculateDeliveryValueSimple(
            totalValue, percentage, currency, exchangeRate, vatRate, priceType
        );
    ...
    test('calculateDeliveryValueSimple obsługa nieprawidłowych danych wejściowych', () => {
        ...
        const result1 = DeliveryCalculator.calculateDeliveryValueSimple(
            undefined as any,
            undefined as any,
            "PLN"
        );
        ...
        const result2 = DeliveryCalculator.calculateDeliveryValueSimple(
            "1000" as any,
            "50" as any,
            "PLN"
        );
        ...
        const result3 = DeliveryCalculator.calculateDeliveryValueSimple(
            1000,
            50,
            "USD" as any
        );
    ...
    test('calculateDeliveryValue obsługa nieprawidłowych danych produktów', () => {
        const products = [
            { price: undefined as any, quantity: 2 },
            { price: "200" as any, quantity: "1" as any }
        ];
